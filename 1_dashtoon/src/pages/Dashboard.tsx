...
function DashBoard() {
  ...
  return (
    <div className="flex flex-col mt-3">
     ...
     <p
       className="flex justify-center w-full text-md text-muted-foreground"
       style={{
         border: "2px solid #000", // Add a black border
         padding: "10px",
         margin: "20% 20%",// Add padding for space inside the box
        ...
        {comic &&
          comic.cardArray.map((card) => (
            ...
            >
              ...
              <button onClick={() => handleDownload(card.img)} className="absolute bottom-0 right-0 bg-blue-500 text-white p-2 rounded">
        Download
      </button>
            </Card>
          ))}
